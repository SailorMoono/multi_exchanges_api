  ...
  async basePost (URI,body) {
      ...
      const params = {
          ...
          headers: {
              ...
              'OK-ACCESS-SIGN':this.encrypt(timestamp + 'POST' + URI + JSON.stringify(body),this.secretKey),
      ...
      return this.safeExecute(this.post(params.baseUrl + URI, body, params.headers), 'basePost');
    }
